...
(function ($) {
    ...
    $('.slider-active-2').owlCarousel({
        loop: true,
        nav: true,
        autoplay: true,// Changed by sami 19.03.2020
    ...
    $('.course-slider-active-3').slick({
        ...
        slidesToShow: 4,
        slidesToScroll: 1,
        autoplay: true,// added by sami 19.03.2020
        autoplaySpeed: 2000,// added by sami 19.03.2020
        prevArrow: '<span class="b-navigation b-navigation-prev "><i class="fa fa-angle-left"></i></span>',
        nextArrow: '<span class="b-navigation b-navigation-next active"><i class="fa fa-angle-right"></i></span>',
        responsive: [
            {
    ...
    $('.brand-logo-active').owlCarousel({
        ...
        nav: false,
        autoplay: true,// Changed by sami 19.03.2020
        autoplayTimeout: 2000,// Changed by sami 19.03.2020
        animateOut: 'fadeOut',
        animateIn: 'fadeIn',
        margin:30,
        item: 6,
    ...
    $('.testimonial-image-slider').slick({
      ...
      centerPadding: '0px',
      autoplay: true,// added by sami 19.03.2020
      autoplaySpeed: 5000,// added by sami 19.03.2020
      responsive: [
        {
          breakpoint: 992,
          settings: {
